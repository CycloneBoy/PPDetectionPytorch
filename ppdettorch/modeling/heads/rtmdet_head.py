...
class RTMDetHead(nn.Module):
    ...
    def _generate_anchors(self, feats=None, dtype='float32'):
        ...
        for i, stride in enumerate(self.fpn_strides):
            ...
            stride_tensor.append(torch.full([h * w, 1], stride, dtype=torch.float32, device=run_device))
    ...
    def _generate_anchor_point(self, feat_sizes, strides, offset=0.):
        ...
        anchor_points = torch.concat(anchor_points).astype(self._dtype)
