...
class ELANFPN(nn.Module):
    ...
    def forward(self, feats, for_mot=False):
        ...
        f_out1 = torch.concat([route_c4, p5_up], 1)  # 512 # [8, 512, 40, 40]
...
class ELANFPNP6(nn.Module):
    ...
    def forward(self, feats, for_mot=False):
        ...
        f_out1 = torch.concat([route_c5, p6_up], 1)  # 768 # [8, 768, 40, 40]
        ...
        f_out2 = torch.concat([route_c4, fpn_out1_up],
                               1)  # 512 # [8, 512, 80, 80]
        ...
        p_out3 = torch.concat([pan_out2_down, c6], 1)  # 512 + 512 -> 1024
