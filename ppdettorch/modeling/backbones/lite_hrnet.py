...
from ppdettorch.modeling.shape_spec import ShapeSpec
...
class CrossResolutionWeightingModule(nn.Module):
    def __init__(self,
                 channels,
                 ratio=16,
                 norm_type='bn',
...
class SpatialWeightingModule(nn.Module):
...
class ConditionalChannelWeightingBlock(nn.Module):
    def __init__(self,
                 in_channels,
                 stride,
                 reduce_ratio,
